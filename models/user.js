...
module.exports = (sequelize, DataTypes) => {
  class user extends Model {
    static associate({Branch,User_Log,NotificationUser,Request,Job,DocumentUser,OfflineChat}) {
      ...
      this.hasMany(OfflineChat,{foreignKey:'from'})
      this.hasMany(OfflineChat,{foreignKey:'to'})
    }
    toJSON(){
